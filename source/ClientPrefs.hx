...
class ClientPrefs {
	...
	public static var superfuckingHD:Bool = false;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.superfuckingHD = superfuckingHD;
	...
	public static function loadPrefs() {
		if(FlxG.save.data.superfuckingHD != null) {
			superfuckingHD = FlxG.save.data.superfuckingHD;
		}
		if(FlxG.save.data.followChars != null) {
			downScroll = FlxG.save.data.followChars;
		}
